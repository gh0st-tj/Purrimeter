...
const CAMPAIGN = [
  ...
  { name: "Yarn Day", tip: "🧶 Yarn is worth +3. Fit as many balls inside your meadow as your fences allow.",
    ...
    map: ["........", "..y.....", ".~~.y...", ".~C.....", ".~......", "....y...", "........"] },
  { name: "Boulders", tip: "🪨 Rocks are free walls, just like ponds. Only the open side needs fencing.",
    walls: 4, target: 12, solution: [703, 704, 705],
    map: [".........", ".........", "..#####..", "..#...#..", "..#.C.#..", "..#...#..", "..#...#..", "........."] },
  ...
  { name: "Tuna Heist", tip: "🐟 Tuna is worth +10 — a jackpot. The rocks already guard it; just close the gap.",
    ...
    map: ["........", ".##.....", ".#t.....", "........", "..C.....", ".~~.....", ".~....y.", "........"] },
  { name: "Box Magic", tip: "📦 Boxes are portals: Mochi teleports between the pair. Both ends count — or block one with a fence.",
  ...
  { name: "Box Blocker", tip: "This pond pen looks perfect, but the box leads OUT. Block the escape box.",
    ...
    map: [".........", ".~~~~~...", ".~.y.~...", ".~.C.~...", ".~.1.~...", ".~~.~~...", ".........", "...1.....", "........."] },
  { name: "Twin Ponds", tip: "Two ponds, lots of yarn. Which bank gives the most meadow for your fences?",
  ...
  { name: "Clover Field", tip: "Plenty of room to be greedy. Should you be?",
    ...
    map: ["..........", "..........", "...~.C....", "..~~......", "..y~y.tu..", "...~~uy...", "..........", ".........."] },
  { name: "Sunny Acres", tip: "The ponds carve this garden into choices. Find the richest pen.",
  ...
  { name: "Rock Maze", tip: "Rocks everywhere — free walls if you pick the right pocket.",
    ...
    map: ["...........", ".#..y..#...", "...##......", ".t.....#.u.", "...#.C.....", ".#.....#...", "...#.....y.", ".u...#.....", ".y.....#.t.", "...#.......", "..........."] },
  { name: "Meadow Sprawl", tip: "A wide-open garden with many good pens, but only one best pen.",
  ...
  { name: "Split Pantry", tip: "A rock pocket and a pond pocket almost meet. Stitch them together for the tuna.",
    ...
    map: ["..........", "..........", ".#.....~..", "..u..t.~~.", "..yy...~..", "..#yC#.y..", "..#.......", "..........", ".........."] },
  { name: "Hidden Picnic", tip: "The tuna is close, but the best enclosure bends around the rock pocket.",
  ...
  { name: "The Great Wall", tip: "Two gaps in an ancient wall. The cheapest plug scores huge — spot it.",
    ...
    map: ["...........", ".....y.....", "...........", "##.####.###", "~....C....~", "~.y.....t.~", "~....u....~", "~~~~~~~~~~~", "..........."] },
  { name: "Grand Garden", tip: "The final capstone: ponds, boxes, tuna and cucumbers, and 12 fences. Make it count.",
