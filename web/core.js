...
const CAMPAIGN = [
  { name: "Cozy Corner", tip: "Tap grass to fence. The pond is a free wall — cats hate water.",
    walls: 4, target: 7, solution: [104, 303, 204, 402],
    map: ["~~~~...", "~.C....", "~......", "~~.....", ".......", ".......", "......."] },
  { name: "Tight Squeeze", tip: "A tiny garden. Every single fence counts here.",
    walls: 5, target: 6, solution: [302, 203, 2, 3, 104],
    map: ["......", ".#.y..", ".#C...", "......", ".~~...", "......"] },
  { name: "Stretch Out", tip: "No diagonal moves — diagonal gaps are safe. Push fences outward.",
    walls: 8, target: 7, solution: [102, 201, 4, 105, 3, 404, 305, 206],
    map: [".......", ".......", "...C...", "..~~...", "..~....", ".......", "......."] },
  { name: "Yarn Day", tip: "Yarn is +3. Three balls, not enough fences — choose well.",
    walls: 7, target: 10, solution: [502, 203, 304, 603, 405, 604, 505],
    map: ["........", "..y.....", ".~~.y...", ".~C.....", ".~......", "....y...", "........"] },
  { name: "Tuna Heist", tip: "Tuna is +10. The rocks guard it for free.",
    walls: 8, target: 21, solution: [503, 404, 3, 104, 305, 400, 205, 300],
    map: ["........", ".##.....", ".#t.....", "........", "..C.....", ".~~.....", ".~....y.", "........"] },
  { name: "Cucumber Patch", tip: "Cucumbers are −5 inside. Weave between them — or fence on top of one.",
    walls: 9, target: 16, solution: [206, 504, 403, 506, 605, 105, 104, 203, 302],
    map: [".........", "..u......", "....y....", ".u..C..~~", "....y..~.", "..u......", "....u....", "........."] },
  { name: "Cucumber Shield", tip: "The pond ring has three gaps — two are cucumbers. Fence ON them to finish the wall.",
    walls: 3, target: 16, solution: [103, 503, 306],
    map: [".........", ".~~u~~...", ".~.y.~...", ".~.C.....", ".~.y.~...", ".~~u~~...", ".........", "........."] },
  { name: "Box Magic", tip: "Boxes teleport the cat. Both ends count — or block one with a fence.",
    walls: 6, target: 18, solution: [705, 606, 204, 305, 406, 507],
    map: ["........", ".~~~....", ".~1y....", ".~y.....", ".~~.....", "...##...", "...#C1..", "...##...", "........"] },
  { name: "Box Blocker", tip: "The pond pen is almost perfect — but that box leads OUT. Block it.",
    walls: 4, target: 15, solution: [703, 604, 702, 601],
    map: [".........", ".~~~~~...", ".~.y.~...", ".~.C.~...", ".~.1.~...", ".~~.~~...", ".........", "...1.....", "........."] },
  { name: "The Great Wall", tip: "Two gaps in the old wall. Plug them — or push the plugs further out.",
    walls: 3, target: 41, solution: [605, 202, 207],
    map: ["...........", ".....y.....", "...........", "##.####.###", "~....C....~", "~.y.....t.~", "~....u....~", "~~~~~~~~~~~", "..........."] },
  { name: "The Corridor", tip: "The rocks form a hallway. Seal the ends — mind the side gaps!",
    walls: 7, target: 23, solution: [200, 5, 505, 404, 506, 407, 210],
    map: ["............", ".####.####..", ".C.......t..", ".####.####..", "............", "............"] },
  { name: "Twin Ponds", tip: "Two ponds, lots of yarn. Which bank is worth fencing?",
    walls: 8, target: 15, solution: [204, 305, 605, 603, 502, 301, 401, 704],
    map: [".........", "..~~.y...", "..~......", "....C....", ".y....~~.", ".....y~..", ".t.......", ".........", "........."] },
  { name: "The Moat", tip: "The pond nearly encircles her. But the riches are outside…",
    walls: 6, target: 19, solution: [705, 606, 804, 702, 601, 803],
    map: ["..........", "..~~~~~...", "..~...~...", "..~.C.~...", "..~...~t..", "..~~.~~...", "..........", "....y...y.", "..........", ".........."] },
  { name: "Garden Party", tip: "Grab the tuna, dodge the cucumbers, use every fence.",
    walls: 8, target: 17, solution: [303, 1, 100, 2, 103, 204, 300, 200],
    map: [".........", ".t...~~..", ".....~...", "..C......", ".~~....u.", ".~..y....", "....u..y.", "........."] },
  { name: "Masterpiece", tip: "Leftover fences are wasted points — spend them all.",
    walls: 9, target: 19, solution: [406, 305, 407, 308, 209, 7, 6, 8, 109],
    map: ["..........", ".y..##..t.", "....#.....", "..1...C...", ".~~.......", ".~...u.u..", "..y...u...", ".....1....", ".t........", ".........."] },
  { name: "Fork in the Road", tip: "One corridor, two exits. Yarn up top, tuna down below — you can’t seal both cheaply.",
    walls: 7, target: 22, solution: [3, 4, 603, 704, 5, 705, 606],
    map: [".........", ".~~.y.##.", ".~....#..", ".~..C.#..", ".~....#..", ".~~..##..", "...u.....", "..t......", "........."] },
  { name: "Cucumber Alley", tip: "A wall of cucumbers guards the tuna. Through, around… or on top?",
    walls: 10, target: 11, solution: [300, 200, 203, 1, 100, 2, 103, 303, 400, 403],
    map: ["........", ".y.u....", "...u....", ".C.u..t.", "...u....", ".~~u....", ".~.u....", "...u..y.", "........", "........"] },
  { name: "Riverbend", tip: "The river does most of the work — if you fence the right bank.",
    walls: 6, target: 27, solution: [300, 200, 400, 706, 1, 100],
    map: ["..........", "..~~~~~~..", ".......~..", ".y..C..~..", ".......~..", ".~~~~..~..", "....~..~..", ".t..~.u~..", "....~~~~..", ".........."] },
  { name: "Bridge Toll", tip: "The bridge is valuable, but the cucumber toll means the smallest seal is not always best.",
    walls: 9, target: 24, solution: [4, 5, 106, 804, 705, 803, 702, 3, 102],
    map: ["..........", "....t.....", "..~~.~~...", "..~...~...", "..~.C.~...", "..~.u.~...", "..~~.~~...", "....y.....", ".........."] },
  { name: "Double Trouble", tip: "TWO box pairs. The cat can hop across the whole garden.",
    walls: 8, target: 23, solution: [606, 406, 507, 902, 903, 204, 305, 502],
    map: [".........", ".~~~.....", ".~1y.....", ".~~......", "...###...", "....C12..", "...###...", ".~~~.....", ".~2t~....", "........."] },
  { name: "Secret Tunnel", tip: "A box pair hides the best expansion.",
    walls: 9, target: 26, solution: [501, 301, 306, 505, 105, 206, 703, 400, 4],
    map: [".........", "..~~.....", "..~..1y..", "..tu..u..", "..y##.#..", "..C1yu...", "..~.#y...", "..~......", "..~......"] },
  { name: "Clover Field", tip: "Plenty of room to be greedy. Should you be?",
    walls: 9, target: 28, solution: [407, 505, 606, 507, 104, 106, 207, 5, 308],
    map: ["..........", "..........", "...~.C....", "..~~......", "..y~y.tu..", "...~~uy...", "..........", ".........."] },
  { name: "Bramble Patch", tip: "Four yarns, three cucumbers — pick your battles.",
    walls: 9, target: 27, solution: [204, 303, 606, 507, 705, 307, 408, 206, 105],
    map: ["..........", "..........", "...yu..u..", "....t..u..", "..~~y..y..", "...~~C.y..", "..~~~.....", "....~....."] },
  { name: "Sunny Acres", tip: "The ponds carve this garden into choices.",
    walls: 9, target: 29, solution: [606, 507, 705, 604, 303, 106, 408, 402, 309],
    map: ["..~.......", "..~.~..#..", "..y.~~.y#.", "..........", "..........", "..u#.Ct...", ".......y..", "..........", ".........."] },
  { name: "Tuna Lock", tip: "The tuna sits in a rock pocket. Bend the fence around the pocket instead of boxing the cat tightly.",
    walls: 9, target: 30, solution: [603, 606, 507, 704, 401, 206, 307, 705, 408],
    map: ["..........", "..####....", "..#t.#....", "..#..#....", "....C..y..", ".~~....u..", ".~.....y..", ".........."] },
  { name: "Thicket Path", tip: "Weave the fence between prizes and penalties.",
    walls: 10, target: 30, solution: [402, 104, 205, 305, 103, 202, 506, 301, 407, 501],
    map: ["........", "........", "....y...", "...C.u#.", "..ut#y..", "........", "..#..#..", "...~~~..", "........", "......~."] },
  { name: "Twin Teleport", tip: "Two portal pairs create one long shortcut. Blocking the right box is sometimes worth more than enclosing it.",
    walls: 10, target: 31, solution: [603, 502, 704, 105, 407, 104, 706, 607, 401, 805],
    map: ["..........", ".1....2...", ".~~~..~...", ".~y...~...", "....C.....", "..u...#2..", ".....t....", ".1........", ".........."] },
  { name: "Rock Maze", tip: "Rocks everywhere — free walls if you pick the right pocket.",
    walls: 10, target: 32, solution: [206, 606, 300, 105, 200, 704, 400, 408, 602, 102],
    map: ["...........", ".#..y..#...", "...##......", ".t.....#.u.", "...#.C.....", ".#.....#...", "...#.....y.", ".u...#.....", ".y.....#.t.", "...#.......", "..........."] },
  { name: "Meadow Sprawl", tip: "A wide-open garden — many good pens, one best pen.",
    walls: 10, target: 33, solution: [501, 505, 202, 301, 104, 205, 400, 103, 406, 306],
    map: ["..........", "..........", "...y......", "..........", "...Cy.....", "..ty..u...", "..~~~u.y..", ".....#....", "....~....."] },
  { name: "Ribbon Canal", tip: "A ribbon of water does half the work. Spend fences where the canal stops helping.",
    walls: 10, target: 34, solution: [106, 207, 5, 308, 503, 402, 606, 507, 604, 408],
    map: [".........", ".~~~~....", "..~~~....", "..~.t.y..", "..u.yC...", ".....#y..", ".........", "........."] },
  { name: "Yarn Orchard", tip: "The orchard is rich, but the cucumber lane makes a greedy meadow expensive.",
    walls: 9, target: 35, solution: [401, 503, 304, 504, 102, 201, 3, 300, 4],
    map: ["........", ".....#..", "...y.t~.", "..C.u.~.", "..yyy~~.", "..#u....", "..#.....", "........"] },
  ...
  { name: "Marsh Mirage", tip: "The marsh tempts you into odd shapes. Count the side gaps before chasing every yarn.",
    ...
    map: [".........", "...~~.#..", "...~~yu..", "..~~y....", "..uyyt...", "...~..C#.", "..~~#.#..", ".~~......", "........."] },
  { name: "Hidden Picnic", tip: "The tuna is not far away, but the best enclosure bends around the rock pocket.",
    walls: 10, target: 41, solution: [602, 501, 702, 407, 206, 307, 804, 105, 507, 805],
    map: ["........", "........", ".~~~~y..", ".~...C..", ".#y.....", "....ty..", "..u...#.", "......#.", "...~...."] },
  { name: "Grand Garden", tip: "The final capstone. Ponds, boxes, tuna, cucumbers — and 12 fences.",
    walls: 12, target: 43, solution: [703, 602, 804, 207, 308, 106, 104, 905, 806, 5, 409, 707],
    map: ["...........", ".y.....u...", "..~~....u..", "...~y...1..", ".##..t.....", ".#..C..~~..", ".......~...", "...u.y.....", ".u1.....t..", "...........", "..........."] },
].map(parseLevel);
